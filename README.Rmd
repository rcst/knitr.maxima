...
- silently insert maxima command set_tex_enviroment(":=", "$$", "$$") at the beginning of each code chunk --> has no effect after loading mactex-utilities ...
- wrap whole code chunk output in \begin{plain} ... \end{plain} instead of individually
